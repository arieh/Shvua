describe(['spec_helpers/adapter','spec_helpers/testThreeCases', 'spec_helpers/assert'], "3.2.3: If `onRejected` is a function,", function (adapter, testThreeCases, assert) {
