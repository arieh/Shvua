describe(['spec_helpers/assert','spec_helpers/testThreeCases', 'spec_helpers/sinon'], "3.2.5: `then` may be called multiple times on the same promise.",
function (assert, testThreeCases, sinon) {
